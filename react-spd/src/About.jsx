    ...
    <div className="text-gray-800">
      ...
      <div className="relative w-full h-72 bg-cover bg-center" style={{ backgroundImage: 'url(https://source.unsplash.com/random/1920x1080)' }}>
        <div className="relative flex items-center justify-center h-full">
          <h1 className="text-4xl md:text-6xl font-bold text-[#5b2a6e] text-center">About Us</h1>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#e6d7e8] rounded-lg p-6 text-center shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-[#5b2a6e]">John Doe</h3>
          ...
          <div className="bg-[#e6d7e8] rounded-lg p-6 text-center shadow-lg">
            <img src="https://source.unsplash.com/random/200x200?person" alt="Team Member" className="w-32 h-32 rounded-full mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-[#5b2a6e]">Jane Smith</h3>
          ...
          <div className="bg-[#e6d7e8] rounded-lg p-6 text-center shadow-lg">
            <img src="https://source.unsplash.com/random/200x200?person" alt="Team Member" className="w-32 h-32 rounded-full mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-[#5b2a6e]">Alice Johnson</h3>
