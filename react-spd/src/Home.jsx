  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-[#4A4063] via-[#BFACC8] to-[#783F8E] px-4 md:px-0">
      ...
      <div className="w-full max-w-md space-y-6">
        <button
          className="relative inline-flex items-center justify-center w-full px-6 py-4 text-lg font-bold text-white bg-[#783F8E] rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 group hover:scale-105 hover:shadow-lg hover:shadow-[#4A4063]/50"
        ...
        <button
          className="relative inline-flex items-center justify-center w-full px-6 py-4 text-lg font-bold text-white bg-[#4A4063] rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 group hover:scale-105 hover:shadow-lg hover:shadow-[#4A4063]/50"
